...
| `extensions/drydock-ide/` | the Parlay extension, built in like `git` or `emmet`: the Claude right-click actions and skills, the Aqua, Meshy and Sonar sidebars, the themes, the Script Sync helpers ([its README](extensions/drydock-ide/README.md)) |
