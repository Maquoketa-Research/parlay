...
export class MultiEditorTabsControl extends EditorTabsControl {
	...
	private static get MODERN_UI_COMPACT_PINNED_TAB_WIDTH() {
		return FONT.tabsSize28;
	}
	...
	constructor(
		...
		super(parent, editorPartsView, groupsView, groupView, tabsModel, menuIds, breadcrumbsInHeader, contextMenuService, instantiationService, contextKeyService, keybindingService, notificationService, quickInputService, themeService, editorResolverService, hostService, menuService, configurationService);
