"""Generate the three Parlay colour themes from one palette each. Run: python tools/themes.py
...
THEMES = {
    "parlay-dark": {"name": "Parlay Dark", "type": "dark", "semanticHighlighting": True, "colors": dark_colors, "tokenColors": dark_tokens},
    "parlay-aqua": {"name": "Parlay Aqua", "type": "dark", "semanticHighlighting": True, "colors": aqua_colors, "tokenColors": aqua_tokens},
    "parlay-glass": {"name": "Parlay Glass", "type": "dark", "semanticHighlighting": True, "colors": glass_colors, "tokenColors": dark_tokens},
    "parlay-paper": {"name": "Parlay Paper", "type": "light", "semanticHighlighting": True, "colors": paper_colors, "tokenColors": paper_tokens},
}
